...
\usepackage{pmmeta}
\pmcanonicalname{QRDecomposition}
\pmcreated{2013-03-22 12:06:04}
\pmmodified{2013-03-22 12:06:04}
\pmowner{akrowne}{2}
\pmmodifier{akrowne}{2}
\pmtitle{QR decomposition}
\pmrecord{8}{31207}
\pmprivacy{1}
\pmauthor{akrowne}{2}
\pmtype{Definition}
...
\pmsynonym{QR factorization}{QRDecomposition}
\pmsynonym{QR-decomposition}{QRDecomposition}
\pmsynonym{QR-factorization}{QRDecomposition}
%\pmkeywords{matrix factorization}
\pmrelated{LUDecomposition}
